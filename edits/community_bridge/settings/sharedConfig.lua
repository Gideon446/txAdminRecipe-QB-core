...
BridgeSharedConfig.Notify        = "ox_lib"        -- [ auto | ox_lib | r_notify | wasabi_notify | lation_ui | okokNotify | mythic_notify | pNotify | t-notify | brutal_notify | FL-Notify]
BridgeSharedConfig.HelpText      = "ox_lib"        -- [ auto | ox_lib | jg-textui | lation_ui | cd_drawtextui | lab-HintUI | okokTextUI]
